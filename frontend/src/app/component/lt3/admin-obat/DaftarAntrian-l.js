    ...
    const fetchQueueList = async () => {
      try {
        ...
        let filteredQueues = response.data.filter(
          (item) => item.status.toLowerCase() === selectedStatus && item.lokasi === "Lantai 3 GMCB"
        );
  ...
  return (
    <Box sx={{ padding: "10px" }}>
      ...
      >
        ...
        >
          <MenuItem value="waiting_pickup_medicine">Waiting Pickup</MenuItem>
          <MenuItem value="called_pickup_medicine">Called Pickup</MenuItem>
          <MenuItem value="recalled_pickup_medicine">Recalled Pickup</MenuItem>
          <MenuItem value="pending_pickup_medicine">Pending Pickup</MenuItem>
        ...
        <TableRow key={item.booking_id} hover>
          <TableCell align="center">
            ...
            />
                ...
                <TableCell align="center">
                  {item.status_medicine === "Tidak ada Racikan"
                    ? "Non-Racikan"
                    : "Racikan"}
                </TableCell>
              </TableRow>
