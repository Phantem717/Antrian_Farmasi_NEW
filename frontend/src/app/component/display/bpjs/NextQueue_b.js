...
const [times, setTimes] = useState({
 ...
 function calculateTime(verifLength, processLengthNon, processLengthRacik, pickupLengthNon, pickupLengthRacik) {
  ...
  const verifTime = verifLength < 3 ? 5 : verifLength * 0.5;
  const processTimeNon = processLengthNon < 3 ? 5 : (processLengthNon * 0.5);
  const processTimeRacik = processLengthRacik < 3 ? 5 : (processLengthRacik * 0.5);
  const pickupTimeNon = pickupLengthNon < 3 ? 5 : (pickupLengthNon * 0.5);
  const pickupTimeRacik = pickupLengthRacik < 3 ? 5 : (pickupLengthRacik * 0.5);
