...
const socket = getSocket();
  ...
  const processTimeNon = processLengthNon < 3 ? 10 : (processLengthNon * 5);
  const processTimeRacik =processLengthRacik< 3 ? 10 : (processLengthRacik * 5)
  const pickupTimeNon = pickupLengthNon < 3 ? 10 : (pickupLengthNon * 5);
  const pickupTimeRacik = pickupLengthRacik < 3 ? 10 : (pickupLengthRacik * 5);
