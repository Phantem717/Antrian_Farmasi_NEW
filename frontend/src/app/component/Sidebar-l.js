...
const Sidebar = ({ collapsed, setCollapsed }) => {
  ...
  const menuKeyMapping = {
    "/login/lt3/admin-verif-b": "1",
    "/login/lt3/admin-proses-b": "2",
    "/login/lt3/admin-obat-b": "3",
    "/manajemen-akun": "4",
    "/kinerja-pelayanan": "5",
    "/login/lt3/edit-marquee-b": "6",
    "/login/logs": "7"
  ...
  const menuItems = [
    {
      ...
      onClick: () => router.push("/login/lt3/admin-verif-l"),
    },
    {
      key: "2",
      icon: <VideoCameraOutlined />,
      label: "Admin Proses Obat",
      onClick: () => router.push("/login/lt3/admin-proses-l"),
    },
    {
      key: "3",
      icon: <SettingOutlined />,
      label: "Admin Obat",
      onClick: () => router.push("/login/lt3/admin-obat-l"),
    },
    {
      key: "4",
      icon: <SettingOutlined />,
    ...
    },
    {
      ...
      icon: <EditOutlined />,
      label: "Edit Marquee",
      onClick: () => router.push("/login/edit-marquee"),
    },
    {
      key: "6",
      icon: <EditOutlined />,
