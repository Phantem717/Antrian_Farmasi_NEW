'use client'
import QueueCall from '@/app/component/display/gmcb/QueueCall_g';
import ServingQueue from '@/app/component/display/gmcb/ServingQueue_g';
import MissQueue from '@/app/component/display/gmcb/MissQueue_g';
import NextQueue from '@/app/component/display/gmcb/NextQueue_g';
import InfoBar from '@/app/component/display/gmcb/InfoBar_g';
import MarqueeFooter from '@/app/component/display/gmcb//MarqueeFooter_g';
...
const socket = getSocket();
  async function getResponses(){
    setLoading(true);
    try {
      const response = await responses.getAllResponses("Lantai 1 GMCB");
